...
class appAppKernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'prestashop.module.customuserdiscounts.controller' => 'getPrestashop_Module_Customuserdiscounts_ControllerService.php',
            'prestashop.module.customuserdiscounts.repository.discount_repository' => 'getPrestashop_Module_Customuserdiscounts_Repository_DiscountRepositoryService.php',
