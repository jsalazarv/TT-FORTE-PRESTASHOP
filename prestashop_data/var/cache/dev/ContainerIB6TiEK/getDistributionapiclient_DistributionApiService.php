...
$b->push(new \PrestaShop\Module\DistributionApiClient\Middleware\Cache(\Doctrine\Common\Cache\Psr6\DoctrineProvider::wrap(new \Symfony\Component\Cache\Adapter\FilesystemAdapter('', 86400, (\dirname(__DIR__, 2).'/dev//distribution-api')))));
